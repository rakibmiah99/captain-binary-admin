            ...
            <div  class="btn-group lang-btn d-inline me-3">
                <button type="button" class="btn btn-outline-primary rounded-0 dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    @elseif(app()->getLocale() == 'bn')
                        <img height="15px" class="mr-2 me-2" src="{{asset('/assets/bn.png')}}"/>
                        <span class="text-uppercase">{{__('page.bangla')}}</span>
                    @endif
                </button>
                <ul class="dropdown-menu" style="">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{route('lang.change', 'bn')}}">
                            <img height="15px" class="mr-2 me-2" src="{{asset('/assets/bn.png')}}"/>
                            <span class="text-uppercase">{{__('page.bangla')}}</span>
                        </a>
                    </li>
